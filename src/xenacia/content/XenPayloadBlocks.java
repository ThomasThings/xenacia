...
public class XenPayloadBlocks{
    ...
    public static void load() {
        smallPayloadConveyor = new PayloadConveyor("small-payload-conveyor"){{
            requirements(Category.units, with(XenItems.iron, 10,XenItems.xenGraphite, 10,XenItems.xenSilicon, 5));
            health = 900;
            size = 3;
            payloadLimit = 3f;
            canOverdrive = true;
        ...
        largePayloadConveyor = new PayloadConveyor("large-payload-conveyor"){{
            requirements(Category.units, with(XenItems.neodymium, 40,XenItems.xenGraphite, 30,XenItems.xenSilicon, 30));
            health = 2500;
            size = 5;
            payloadLimit = 5.5f;
            canOverdrive = true;
        ...
        smallPayloadRouter = new PayloadRouter("small-payload-router"){{
            requirements(Category.units, with(XenItems.iron, 15,XenItems.xenGraphite, 10,XenItems.xenSilicon, 10));
            health = 900;
            size = 3;
            payloadLimit = 3f;
            canOverdrive = true;
        ...
        largePayloadRouter = new PayloadRouter("large-payload-router"){{
            requirements(Category.units, with(XenItems.neodymium, 50,XenItems.xenGraphite, 30,XenItems.xenSilicon, 40));
            health = 2500;
            size = 5;
            payloadLimit = 5.5f;
            canOverdrive = true;
        ...
        smallPayloadConstructor = new Constructor("small-payload-constructor"){{
            requirements(Category.units, with(XenItems.iron, 100,XenItems.xenGraphite, 100));
            health = 900;
            size = 3;
            hasPower = true;
            buildSpeed = 0.7f;
        ...
        largePayloadConstructor = new Constructor("large-payload-constructor"){{
            requirements(Category.units, with(XenItems.cobalt, 250, XenItems.iron, 200,XenItems.xenSilicon, 150));
            health = 2500;
            size = 7;
            minBlockSize = 2;
            maxBlockSize = 5;
        ...
        smallPayloadLoader = new PayloadLoader("small-payload-loader"){{
            requirements(Category.units, with(XenItems.aluminum, 100,XenItems.xenGraphite, 80,XenItems.xenSilicon, 80));
            health = 900;
            size = 3;
            hasPower = true;
            consumePower(2f);
        ...
        largePayloadLoader = new PayloadLoader("large-payload-loader"){{
            requirements(Category.units, with(XenItems.cobalt, 150, XenItems.aluminum, 100,XenItems.xenGraphite, 200,XenItems.xenSilicon, 200));
            health = 2500;
            size = 7;
            maxBlockSize = 6;
            hasPower = true;
        ...
        smallPayloadLaunchTower = new PayloadMassDriver("small-payload-launch-tower"){{
            requirements(Category.units, with(XenItems.iron, 80, XenItems.aluminum, 80,XenItems.xenSilicon, 80));
            health = 900;
            size = 3;
            reload = 150f;
            chargeTime = 60f;
        ...
        largePayloadLaunchTower = new PayloadMassDriver("large-payload-launch-tower"){{
            requirements(Category.units, with(XenItems.iron, 500, XenItems.aluminum, 550,XenItems.xenSilicon, 450, XenItems.cobalt, 250));
            health = 4900;
            size = 7;
            reload = 240f;
            chargeTime = 120f;
        ...
        smallPayloadDeconstructor = new PayloadDeconstructor("small-payload-deconstructor"){{
            requirements(Category.units, with(XenItems.aluminum, 100,XenItems.xenGraphite, 1000));
            health = 900;
            size = 3;
            itemCapacity = 200;
            consumePower(2f);
        ...
        largePayloadDeconstructor = new PayloadDeconstructor("large-payload-deconstructor"){{
            requirements(Category.units, with(XenItems.cobalt, 250, XenItems.aluminum, 200,XenItems.xenSilicon, 150));
            health = 2500;
            size = 7;
            maxPayloadSize = 6;
            itemCapacity = 300;
