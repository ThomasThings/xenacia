...
public class PSWalls{
    ...
    public static void load(){
        ...
        bulkIronWall = new Wall("bulk-iron-wall"){{
            requirements(Category.defense, with(PSItems.iron, 8 * 4, PSItems.aluminum, 4 * 4));
            health = 400 * 2 * 4;
            size = 2;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkIronWallLarge = new Wall("bulk-iron-wall-large"){{
            requirements(Category.defense, with(PSItems.iron, 8 * 9, PSItems.aluminum, 4 * 9));
            health = 400 * 2 * 9;
            size = 3;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkIronWallHuge = new Wall("bulk-iron-wall-huge"){{
            requirements(Category.defense, with(PSItems.iron, 8 * 16, PSItems.aluminum, 4 * 16));
            health = 400 * 2 * 16;
            size = 4;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        graphiteWall = new Wall("graphite-wall"){{
            requirements(Category.defense, with(Items.graphite, 4, PSItems.aluminum, 2));
            health = 450;
            size = 1;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        graphiteWallLarge = new Wall("graphite-wall-large"){{
            requirements(Category.defense, with(Items.graphite, 4 * 4, PSItems.aluminum, 2 * 4));
            health = 450 * 4;
            size = 2;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkGraphiteWall = new Wall("bulk-graphite-wall"){{
            requirements(Category.defense, with(Items.graphite, 6 * 4, PSItems.iron, 6 * 4));
            health = 450 * 2 * 4;
            size = 2;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkGraphiteWallLarge = new Wall("bulk-graphite-wall-large"){{
            requirements(Category.defense, with(Items.graphite, 6 * 9, PSItems.iron, 6 * 9));
            health = 450 * 2 * 9;
            size = 3;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkGraphiteWallHuge = new Wall("bulk-graphite-wall-huge"){{
            requirements(Category.defense, with(Items.graphite, 6 * 16, PSItems.iron, 6 * 16));
            health = 450 * 2 * 16;
            size = 4;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        cobaltWall = new Wall("cobalt-wall"){{
            requirements(Category.defense, with(PSItems.cobalt, 6));
            health = 1000;
            size = 1;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        cobaltWallLarge = new Wall("cobalt-wall-large"){{
            requirements(Category.defense, with(PSItems.cobalt, 6 * 4));
            health = 1000 * 4;
            size = 2;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkCobaltWall = new Wall("bulk-cobalt-wall"){{
            requirements(Category.defense, with(PSItems.cobalt, 8 * 4, Items.titanium, 4 * 4));
            health = 1000 * 2 * 4;
            size = 2;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkCobaltWallLarge = new Wall("bulk-cobalt-wall-large"){{
            requirements(Category.defense, with(PSItems.cobalt, 8 * 9, Items.titanium, 4 * 9));
            health = 1000 * 2 * 9;
            size = 3;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
        ...
        bulkCobaltWallHuge = new Wall("bulk-cobalt-wall-huge"){{
            requirements(Category.defense, with(PSItems.cobalt, 8 * 16, Items.titanium, 4 * 16));
            health = 1000 * 2 * 16;
            size = 4;
            researchCostMultiplier = 0.1f;
            envDisabled |= Env.scorching;
